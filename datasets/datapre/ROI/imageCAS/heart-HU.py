...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', '-i', type=str,
                        default="/home/yangrui/Project/Base-models/datasets/datapre/ROI/imageCAS/data/img/2_img.nii.gz",
                        help='输入nii.gz文件路径或目录路径')
    parser.add_argument('--output', '-o', type=str,
                        default="/home/yangrui/Project/Base-models/datasets/datapre/ROI/imageCAS/data/output/2_HU.nii.gz",
